...
RECORD_OPERATOR("+",2,true,"id",[](Value x,Value y){return x+y;})
RECORD_OPERATOR("-",2,true,"neg",[](Value x,Value y){return x-y;})
RECORD_OPERATOR("*",4,true,"",[](Value x,Value y){return x*y;})
RECORD_OPERATOR("/",4,true,"",[](Value x,Value y){return x/y;})
RECORD_OPERATOR("%",4,true,"",[](Value x,Value y){return std::fmod(x,y);})
RECORD_OPERATOR("^",8,false,"",[](Value x,Value y){return std::pow(x,y);})
RECORD_OPERATOR("**",8,false,"",[](Value x,Value y){return std::pow(x,y);})

RECORD_FUNCTION("id",[](Value x){return x;})
RECORD_FUNCTION("neg",[](Value x){return -x;})
